...
#if I didn't specify the value, it said unexpected comma
#Movie.find_by(title:, release_date:, director:)
end

def can_find_using_where_clause_and_be_sorted
  # For this test return all movies released after 2002 and ordered by
  # release date desce"nding
...
def can_be_found_updated_and_saved
  ...
  #it is automatically saved, you return the movie
  Movie
end
...
def can_destroy_a_single_item
  ...
  selection = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  selection.destroy
